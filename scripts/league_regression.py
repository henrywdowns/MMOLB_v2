...
kpis = frier.attrs_regression('batting','team_win_diff',['OBP','SLG','BA','BABIP','ISO'],sm_summary=True,detailed_output=True)

print(frier.reorder_regression_coefs(kpis['sm_results']))
